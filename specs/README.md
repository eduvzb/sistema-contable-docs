...
SPEC-001 está **Lista**; las demás specs iniciales permanecen en **Borrador**. Los pendientes de cada una explican qué falta antes de Lista; no significan que todo el MVP esté bloqueado para su definición.
...
| [SPEC-002](002-contexto-contable.md) | Contexto contable | [SPEC-001](001-acceso-usuarios-empresas.md) |
